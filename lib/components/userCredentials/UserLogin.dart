              ...
              child: ListView(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Container(child:Image.asset("assets/images/hot-pot.png"),width: 130,height: 130,),
                  ),
                  Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          FirebaseAuth.instance
                              ...
                              .then((value) {
                                userDataProvider.login(_emailController.text.trim());
                  ...
                  Row(
                    children: <Widget>[
                      const Text('Do not have an account?',style: TextStyle(fontWeight: FontWeight.w600,color:Colors.white),),
                      TextButton(
                        child: const Text(
                          'Sign up',
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style: TextStyle(color: Colors.red,fontSize: 15,fontWeight: FontWeight.w900),
                        ),
                      ),
                    ),
                  ),
